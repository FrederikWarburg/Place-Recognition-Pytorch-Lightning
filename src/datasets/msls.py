...
class TrainDataset(BaseDataset):
    ...
    def __init__(self, name, mode, imsize=None, transform=None, loader=default_loader, posDistThr=10, negDistThr=25, root_dir = 'data', cities = ''):
        super().__init__(name, mode, imsize, transform, loader, posDistThr, negDistThr, root_dir, cities)
